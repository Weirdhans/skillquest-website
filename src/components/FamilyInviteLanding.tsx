...
export default function FamilyInviteLanding({
  ...
  const appLink = useMemo(() => {
    ...
    return `io.skillquest.app://family?invite=${inviteCode}`;
  }, [inviteCode]);
          ...
          {inviteCode == null ? (
            <>
              <p className="mt-4 text-white/80">
                Deze familie-uitnodigingslink is ongeldig of onvolledig.
              </p>
              <div className="mt-8">
            ...
            <>
              <p className="mt-4 text-white/80">
                We proberen SkillQuest te openen zodat je direct de familie-join
                flow ziet.
              </p>
              ...
              {showFallback && (
                <div className="mt-6 rounded-2xl border border-sky-400/40 bg-sky-500/10 p-4">
                  <p className="text-sm text-sky-100">
                    Lukt openen niet direct? Open SkillQuest en ga naar
                    <span className="font-semibold">
                      {' '}
                      Profiel - Familie - Ik heb een invite-code
                    </span>
                    . Gebruik daar <span className="font-semibold">{inviteCode}</span>.
                  </p>
                  <div className="mt-4">
