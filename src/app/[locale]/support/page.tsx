...
const copyByLocale: Record<string, SupportCopy> = {
  nl: {
    ...
    faq: [
      ...
      {question: 'Hoe werkt Android Early Access?', answer: 'Android is beschikbaar via een besloten test op Google Play. Open de downloadpagina, word lid van de Google Group en meld je met hetzelfde Google-account aan voor de Play-test. Daarna kun je SkillQuest direct via Google Play installeren. De e-mailinschrijving is alleen voor productupdates; iOS is al live in de App Store.'},
  ...
  en: {
    ...
    faq: [
      ...
      {question: 'How does Android Early Access work?', answer: 'Android is available through a Google Play closed test. Open the download page, join the Google Group, and opt in to the Play test with the same Google account. You can then install SkillQuest directly from Google Play. Email signup is only for product updates; iOS is already live on the App Store.'},
  ...
  de: {
    ...
    faq: [
      ...
      {question: 'Wie funktioniert Android Early Access?', answer: 'Android ist über einen geschlossenen Test bei Google Play verfügbar. Öffne die Downloadseite, tritt der Google-Gruppe bei und nimm mit demselben Google-Konto am Play-Test teil. Danach kannst du SkillQuest direkt über Google Play installieren. Die E-Mail-Anmeldung ist nur für Produktupdates; iOS ist bereits im App Store verfügbar.'},
  ...
  fr: {
    ...
    faq: [
      ...
      {question: 'Comment fonctionne l’accès anticipé Android ?', answer: 'Android est disponible via un test fermé sur Google Play. Ouvre la page de téléchargement, rejoins le groupe Google et inscris-toi au test Play avec le même compte Google. Tu peux ensuite installer SkillQuest directement depuis Google Play. L’inscription par e-mail sert uniquement aux mises à jour produit ; iOS est déjà disponible sur l’App Store.'},
  ...
  es: {
    ...
    faq: [
      ...
      {question: '¿Cómo funciona el acceso anticipado de Android?', answer: 'Android está disponible mediante una prueba cerrada de Google Play. Abre la página de descarga, únete al grupo de Google y acepta la prueba de Play con la misma cuenta de Google. Después podrás instalar SkillQuest directamente desde Google Play. El registro por correo es solo para novedades del producto; iOS ya está disponible en App Store.'},
  ...
  it: {
    ...
    faq: [
      ...
      {question: 'Come funziona l’accesso anticipato Android?', answer: 'Android è disponibile tramite un test chiuso su Google Play. Apri la pagina di download, unisciti al gruppo Google e accetta il test Play con lo stesso account Google. Potrai quindi installare SkillQuest direttamente da Google Play. L’iscrizione via email serve solo per gli aggiornamenti prodotto; iOS è già disponibile su App Store.'},
