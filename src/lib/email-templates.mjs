...
const VERIFY_COPY = {
  nl: {
    ...
    platformInfo: (p) => `Je krijgt relevante SkillQuest-updates ${p}, inclusief informatie over Android Early Access als je je daarvoor aanmeldt.`,
    androidNote: 'Voor Android Early Access: gebruik de Google Group-link op de downloadpagina om mee te doen aan de gesloten test. Deze e-mailinschrijving is alleen voor productupdates.',
  ...
  en: {
    ...
    platformInfo: (p) => `You'll get relevant SkillQuest updates ${p}, including Android Early Access information if you opt in.`,
    androidNote: 'For Android Early Access: use the Google Group link on the download page to join the closed test. This email signup is for product updates only.',
  ...
  de: {
    ...
    platformInfo: (p) => `Du erhältst relevante SkillQuest-Updates ${p}, einschließlich Informationen zu Android Early Access, wenn du dich dafür anmeldest.`,
    androidNote: 'Für Android Early Access: Nutze den Google-Gruppenlink auf der Downloadseite, um am geschlossenen Test teilzunehmen. Diese E-Mail-Anmeldung ist nur für Produktupdates.',
  ...
  fr: {
    ...
    platformInfo: (p) => `Tu recevras les dernières infos sur SkillQuest ${p}, y compris des infos sur l’accès anticipé Android si tu t'inscris.`,
    androidNote: 'Pour l’accès anticipé Android : utilise le lien du groupe Google sur la page de téléchargement pour rejoindre le test fermé. Cette inscription par e-mail sert uniquement aux mises à jour du produit.',
  ...
  es: {
    ...
    platformInfo: (p) => `Recibirás las últimas novedades de SkillQuest ${p}, incluida información sobre el acceso anticipado de Android si te suscribes.`,
    androidNote: 'Para el acceso anticipado de Android: usa el enlace del grupo de Google en la página de descarga para unirte a la prueba cerrada. Esta suscripción por correo solo sirve para recibir novedades del producto.',
  ...
  it: {
    ...
    platformInfo: (p) => `Riceverai gli aggiornamenti su SkillQuest ${p}, comprese le informazioni sull’accesso anticipato Android se decidi di iscriverti.`,
    androidNote: 'Per l’accesso anticipato Android: usa il link al gruppo Google nella pagina di download per partecipare al test chiuso. Questa iscrizione via email serve solo per gli aggiornamenti sul prodotto.',
...
const WELCOME_COPY = {
  nl: {
    ...
    next: ['Nieuws over nieuwe functies', 'Info over Android Early Access en de gesloten testfase op Google Play', 'Tips om je vaardigheden en die van je gezin te ontwikkelen'],
    androidNote: '<strong>Over Android Early Access:</strong> gebruik de Google Group-link op de downloadpagina om mee te doen aan de gesloten test. Deze e-mailinschrijving is alleen voor productupdates.',
  ...
  en: {
    ...
    next: ['Updates on new features', 'Information about Android Early Access and Google Play closed testing', 'Tips on skill development for you and your family'],
    androidNote: '<strong>About Android Early Access:</strong> use the Google Group link on the download page to join the closed test. This email signup is for product updates only.',
  ...
  de: {
    ...
    next: ['Neues zu den neuen Funktionen', 'Infos zu Android Early Access und zum geschlossenen Test auf Google Play', 'Tipps zur Kompetenzentwicklung für dich und deine Familie'],
    androidNote: '<strong>Zu Android Early Access:</strong> Nutze den Google-Gruppenlink auf der Downloadseite, um am geschlossenen Test teilzunehmen. Diese E-Mail-Anmeldung ist nur für Produktupdates.',
  ...
  fr: {
    ...
    next: ['Nouveautés concernant les nouvelles fonctionnalités', 'Infos sur l’accès anticipé Android et les tests fermés sur Google Play', 'Des conseils pour développer tes compétences et celles de ta famille'],
    androidNote: '<strong>À propos de l’accès anticipé Android :</strong> utilise le lien du groupe Google sur la page de téléchargement pour rejoindre le test fermé. Cette inscription par e-mail sert uniquement aux mises à jour du produit.',
  ...
  es: {
    ...
    next: ['Novedades sobre las nuevas funciones', 'Información sobre el acceso anticipado de Android y las pruebas cerradas de Google Play', 'Consejos para que tú y tu familia desarrolléis vuestras habilidades'],
    androidNote: '<strong>Sobre el acceso anticipado de Android:</strong> usa el enlace del grupo de Google en la página de descarga para unirte a la prueba cerrada. Esta suscripción por correo solo sirve para recibir novedades del producto.',
  ...
  it: {
    ...
    next: ['Novità sulle nuove funzionalità', 'Informazioni sull’accesso anticipato Android e sul test chiuso di Google Play', 'Consigli su come sviluppare le tue capacità e quelle della tua famiglia'],
    androidNote: '<strong>A proposito dell’accesso anticipato Android:</strong> usa il link al gruppo Google nella pagina di download per partecipare al test chiuso. Questa iscrizione via email serve solo per gli aggiornamenti sul prodotto.',
