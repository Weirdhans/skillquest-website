...
const VERIFY_COPY = {
  nl: {
    ...
    androidNote: 'Voor Android: gebruik de Google Group-link op de downloadpagina om mee te doen aan de gesloten test. Deze e-mailinschrijving is alleen voor productupdates.',
  ...
  en: {
    ...
    androidNote: 'For Android: use the Google Group link on the download page to join the closed test. This email signup is for product updates only.',
  ...
  de: {
    ...
    androidNote: 'Für Android: Nutze den Google-Gruppenlink auf der Downloadseite, um am geschlossenen Test teilzunehmen. Diese E-Mail-Anmeldung ist nur für Produktupdates.',
  ...
  fr: {
    ...
    androidNote: 'Pour Android : utilisez le lien du groupe Google sur la page de téléchargement pour rejoindre le test fermé. Cette inscription par e-mail sert uniquement aux mises à jour du produit.',
  ...
  es: {
    ...
    androidNote: 'Para Android: usa el enlace del grupo de Google en la página de descarga para unirte a la prueba cerrada. Esta suscripción por correo solo sirve para recibir novedades del producto.',
  ...
  it: {
    ...
    androidNote: 'Per Android: usa il link al gruppo Google nella pagina di download per partecipare al test chiuso. Questa iscrizione via email serve solo per gli aggiornamenti sul prodotto.',
...
const WELCOME_COPY = {
  nl: {
    ...
    androidNote: '<strong>Over de Android-alpha:</strong> gebruik de Google Group-link op de downloadpagina om mee te doen aan de gesloten test. Deze e-mailinschrijving is alleen voor productupdates.',
  ...
  en: {
    ...
    androidNote: '<strong>About the Android alpha:</strong> use the Google Group link on the download page to join the closed test. This email signup is for product updates only.',
  ...
  de: {
    ...
    androidNote: '<strong>Zur Android-Alpha-Version:</strong> Nutze den Google-Gruppenlink auf der Downloadseite, um am geschlossenen Test teilzunehmen. Diese E-Mail-Anmeldung ist nur für Produktupdates.',
  ...
  fr: {
    ...
    androidNote: '<strong>À propos de la version alpha pour Android :</strong> utilise le lien du groupe Google sur la page de téléchargement pour rejoindre le test fermé. Cette inscription par e-mail sert uniquement aux mises à jour du produit.',
  ...
  es: {
    ...
    androidNote: '<strong>Sobre la versión alfa para Android:</strong> usa el enlace del grupo de Google en la página de descarga para unirte a la prueba cerrada. Esta suscripción por correo solo sirve para recibir novedades del producto.',
  ...
  it: {
    ...
    androidNote: '<strong>A proposito della versione alpha per Android:</strong> usa il link al gruppo Google nella pagina di download per partecipare al test chiuso. Questa iscrizione via email serve solo per gli aggiornamenti sul prodotto.',
