 ...
 *
 * Translates specific untranslated strings that need translation
 * (excludes technical terms, prices, platform names, etc.)
 */
...
// Specific keys to translate (excluding prices, technical terms, etc.)
const KEYS_TO_TRANSLATE = {
  // Pricing
  'pricing.tiers.guest.priceNote': true,
  'pricing.tiers.free.priceNote': true,

  // Footer
  'footer.copyright': true, // Only "All rights reserved" part
  ...
  // Hero (only some languages)
  'hero.titleAccent': true, // DE
  'hero.features.analytics': true, // NL
  'hero.features.gamification': true, // Optional
  'hero.trust.privacy': true, // IT

  // Pain points
  'painPoints.successStory.before.title': true, // DE
};
